...
insert into "orders"
values (1, current_timestamp, current_timestamp, '1 Rue Vaugirard', NULL, 'Paris', 'FR', '75015', NULL, 'PAID', 999.00,
        1, 2),
       ...
       (4, current_timestamp, current_timestamp, 'Cité Safia 2', NULL, 'Ksour', 'TN', 7160, NULL, 'CREATION', 0, 4,
        NULL),
